...
3. Preservar recall de rostos, gestos e alertas. Ganho de tempo que perde
   deteccao nao e ganho. Atencao: enquanto as regras de gesto contarem analises
   em vez de tempo, a contagem de alertas nao serve para comparar versoes com
   desempenho diferente.
4. `main` (`343d8da`) nao contem esta branch e o deploy so dispara em push na
   `main`: nao presumir que o Raspberry esteja rodando este codigo.
